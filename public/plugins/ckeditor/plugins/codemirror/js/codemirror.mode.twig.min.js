...
CodeMirror.defineMode("twig", function(config, parserConfig) {
    var keywords = ["block", "endblock", "for", "endfor", "in", "true", "false",
                    ...
                    "else", "import", "with", "without", "context", "include", "set", "asset", "path"];
    ...
    return CodeMirror.overlayMode(CodeMirror.getMode(config, parserConfig.backdrop || "htmlmixed"), twigOverlay);
});
